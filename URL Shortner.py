...
bt1=Button(root,text="Generate URL",font=('Arial,20,bold'),bg='green',fg='white',bd=5,command=shorturl)
bt1.pack(pady=10)
btn2=Button(root,text="Copy URL",font=('Arial,20,bold'),bg='green',fg='white',bd=5,command=copyurl)
btn2.pack(pady=10)
